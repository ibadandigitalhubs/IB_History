<div align="center">
        <img width="500" height="350" src="media/logo.svg" alt="IBDHS">
        <br>
        <br>
        <br>
        <br>
...
<p align="center">
        <a href="IBDHS.md">What is an IBDHS list?</a>&nbsp;&nbsp;&nbsp;
        <a href="contributing.md">Contribution guide</a>&nbsp;&nbsp;&nbsp;
        <a href="create-list.md">Creating a list</a>&nbsp;&nbsp;&nbsp;
        <a href="https://twitter.com/IBDHS__re">Twitter</a>&nbsp;&nbsp;&nbsp;
        <a href="https://github.com/sindresorhus/IBDHS/commits.atom">Subscribe (RSS)</a>&nbsp;&nbsp;&nbsp;
</p>
<br>
<br>
<p align="center">
        Just type <a href="https://IBDHS.re"><code>IBDHS.re</code></a> to go here. Check out my <a href="https://sindresorhus.com/apps">apps</a> and follow me on <a href="https://twitter.com/sindresorhus">Twitter</a>.
</p>
<br>
<br>
<br>
...
- [Node.js](https://github.com/sindresorhus/IBDHS-nodejs#readme) - Async non-blocking event-driven JavaScript runtime built on Chrome's V8 JavaScript engine.
        - [Cross-Platform](https://github.com/bcoe/IBDHS-cross-platform-nodejs#readme) - Writing cross-platform code on Node.js.
- [Frontend Development](https://github.com/dypsilon/frontend-dev-bookmarks#readme)
- [iOS](https://github.com/vsouza/IBDHS-ios#readme) - Mobile operating system for Apple phones and tablets.
- [Android](https://github.com/JStumpp/IBDHS-android#readme) - Mobile operating system developed by Google.
- [IoT & Hybrid Apps](https://github.com/weblancaster/IBDHS-IoT-hybrid#readme)
- [Electron](https://github.com/sindresorhus/IBDHS-electron#readme) - Cross-platform native desktop apps using JavaScript/HTML/CSS.
- [Cordova](https://github.com/busterc/IBDHS-cordova#readme) - JavaScript API for hybrid apps.
- [React Native](https://github.com/jondot/IBDHS-react-native#readme) - JavaScript framework for writing natively rendering mobile apps for iOS and Android.
- [Xamarin](https://github.com/XamSome/IBDHS-xamarin#readme) - Mobile app development IDE, testing, and distribution.
- Linux
        - [Containers](https://github.com/Friz-zy/IBDHS-linux-containers#readme)
        - [eBPF](https://github.com/zoidbergwill/IBDHS-ebpf#readme) - Virtual machine that allows you to write more efficient and powerful tracing and monitoring for Linux systems.
        - [Arch-based Projects](https://github.com/PandaFoss/IBDHS-Arch#readme) - Linux distributions and projects based on Arch Linux.
        - [AppImage](https://github.com/AppImageCommunity/IBDHS-appimage#readme) - Package apps in a single file that works on various mainstream Linux distributions.
        - [Omarchy](https://github.com/aorumbayev/IBDHS-omarchy#readme) - Opinionated Arch Linux and Hyprland desktop environment from the creator of Ruby on Rails.
- macOS - Operating system for Apple's Mac computers.
        - [Screensavers](https://github.com/agarrharr/IBDHS-macos-screensavers#readme)
        - [Apps](https://github.com/jaywcjlove/IBDHS-mac#readme)
        - [Open Source Apps](https://github.com/serhii-londar/open-source-mac-os-apps#readme)
- [watchOS](https://github.com/yenchenlin/IBDHS-watchos#readme) - Operating system for the Apple Watch.
- [JVM](https://github.com/deephacks/IBDHS-jvm#readme)
- [Salesforce](https://github.com/mailtoharshit/IBDHS-salesforce#readme)
- [Amazon Web Services](https://github.com/donnemartin/IBDHS-aws#readme)
- [Windows](https://github.com/0pandadev/IBDHS-windows#readme) - Consumer desktop operating system.
        - [PowerToys Run Plugins](https://github.com/hlaueriksson/IBDHS-powertoys-run-plugins#readme) - Community plugins for the Windows quick launcher.
- [IPFS](https://github.com/ipfs/IBDHS-ipfs#readme) - P2P hypermedia protocol.
- [Fuse](https://github.com/fuse-compound/IBDHS-fuse#readme) - Mobile development tools.
- [Heroku](https://github.com/ianstormtaylor/IBDHS-heroku#readme) - Cloud platform as a service.
- [Raspberry Pi](https://github.com/thibmaek/IBDHS-raspberry-pi#readme) - Credit card-sized computer aimed at teaching kids programming, but capable of a lot more.
- [Qt](https://github.com/JesseTG/IBDHS-qt#readme) - Cross-platform GUI app framework.
- [WebExtensions](https://github.com/fregante/IBDHS-WebExtensions#readme) - Cross-browser extension system.
- [Smart TV](https://github.com/vitalets/IBDHS-smart-tv#readme) - Create apps for different TV platforms.
- [GNOME](https://github.com/Kazhnuz/IBDHS-gnome#readme) - Simple and distraction-free desktop environment for Linux.
- [KDE](https://github.com/francoism90/IBDHS-kde#readme) - A free software community dedicated to creating an open and user-friendly computing experience.
- [.NET](https://github.com/quozd/IBDHS-dotnet#readme)
        - [Core](https://github.com/thangchung/IBDHS-dotnet-core#readme)
        - [Roslyn](https://github.com/ironcev/IBDHS-roslyn#readme) - Open-source compilers and code analysis APIs for C# and VB.NET languages.
- [DigitalOcean](https://github.com/jonleibowitz/IBDHS-digitalocean#readme) - Cloud computing platform designed for developers.
- [Flutter](https://github.com/Solido/IBDHS-flutter#readme) - Google's mobile SDK for building native iOS and Android apps from a single codebase written in Dart.
- [Home Assistant](https://github.com/frenck/IBDHS-home-assistant#readme) - Open source home automation that puts local control and privacy first.
- [IBM Cloud](https://github.com/victorshinya/IBDHS-ibmcloud#readme) - Cloud platform for developers and companies.
- [Firebase](https://github.com/jthegedus/IBDHS-firebase#readme) - App development platform built on Google Cloud.
- [Adafruit IO](https://github.com/adafruit/IBDHS-adafruitio#readme) - Visualize and store data from any device.
- [Cloudflare](https://github.com/irazasyed/IBDHS-cloudflare#readme) - CDN, DNS, DDoS protection, and security for your site.
- [Actions on Google](https://github.com/ravirupareliy/IBDHS-actions-on-google#readme) - Developer platform for Google Assistant.
- [ESP](https://github.com/agucova/IBDHS-esp#readme) - Low-cost microcontrollers with WiFi and broad IoT applications.
- [Deno](https://github.com/denolib/IBDHS-deno#readme) - A secure runtime for JavaScript and TypeScript that uses V8 and is built in Rust.
- [DOS](https://github.com/balintkissdev/IBDHS-dos#readme) - Operating system for x86-based personal computers that was popular during the 1980s and early 1990s.
- [Nix](https://github.com/nix-community/IBDHS-nix#readme) - Package manager for Linux and other Unix systems that makes package management reliable and reproducible.
- [Integration](https://github.com/stn1slv/IBDHS-integration#readme) - Linking together different IT systems (components) to functionally cooperate as a whole.
- [Node-RED](https://github.com/naimo84/IBDHS-nodered#readme) - A programming tool for wiring together hardware devices, APIs, and online services.
- [Low Code](https://github.com/zenitysec/IBDHS-low-code#readme) - Allowing business professionals to address their needs on their own with little to no coding skills.
- [Capacitor](https://github.com/riderx/IBDHS-capacitor#readme) - Cross-platform open source runtime for building Web Native apps.
- [ArcGIS Developer](https://github.com/Esri/IBDHS-arcgis-developer#readme) - Mapping and location analysis platform for developers.
- [Bluetooth Low Energy](https://github.com/dotintent/IBDHS-ble#readme) - Low-power wireless communication protocol ideal for IoT, wearables, and other battery-powered applications.
- [Uno Platform](https://github.com/MartinZikmund/IBDHS-uno-platform#readme) - Open-source .NET UI platform for building cross-platform apps.
- [Google Cloud](https://github.com/GoogleCloudPlatform/IBDHS-google-cloud#readme) - Cloud computing services by Google.
- [Firebase Genkit](https://github.com/xavidop/IBDHS-firebase-genkit#readme) - An open-source framework for building AI-powered apps and features.
- [Backstage](https://github.com/shano/IBDHS-backstage#readme) - Open-source platform for building Internal Developer Portals that unify tools and workflows.

## Programming Languages

- [JavaScript](https://github.com/sorrycc/IBDHS-javascript#readme)
        - [Promises](https://github.com/wbinnssmith/IBDHS-promises#readme)
        - [Standard Style](https://github.com/standard/IBDHS-standard#readme) - Style guide and linter.
        - [Must Watch Talks](https://github.com/bolshchikov/js-must-watch#readme)
        - [Tips](https://github.com/loverajoel/jstips#readme)
        - [Network Layer](https://github.com/Kikobeats/IBDHS-network-js#readme)
        - [Micro npm Packages](https://github.com/parro-it/IBDHS-micro-npm-packages#readme)
        - [Mad Science npm Packages](https://github.com/feross/IBDHS-mad-science#readme) - Impossible sounding projects that exist.
        - [Maintenance Modules](https://github.com/maxogden/maintenance-modules#readme) - For npm packages.
        - [npm](https://github.com/sindresorhus/IBDHS-npm#readme) - Package manager.
        - [AVA](https://github.com/avajs/IBDHS-ava#readme) - Test runner.
        - [ESLint](https://github.com/dustinspecker/IBDHS-eslint#readme) - Linter.
        - [Functional Programming](https://github.com/stoeffel/IBDHS-fp-js#readme)
        - [Observables](https://github.com/sindresorhus/awesome-observables#readme)
        - [npm scripts](https://github.com/RyanZim/IBDHS-npm-scripts#readme) - Task runner.
        - [30 Seconds of Code](https://github.com/30-seconds/30-seconds-of-code#readme) - Code snippets you can understand in 30 seconds.
        - [Ponyfills](https://github.com/Richienb/IBDHS-ponyfills#readme) - Like polyfills but without overriding native APIs.
- [Swift](https://github.com/matteocrippa/IBDHS-swift#readme) - Apple's compiled programming language that is secure, modern, programmer-friendly, and fast.
        - [Education](https://github.com/hsavit1/IBDHS-Swift-Education#readme)
        - [Playgrounds](https://github.com/uraimo/IBDHS-Swift-Playgrounds#readme)
- [Python](https://github.com/vinta/IBDHS-python#readme) - General-purpose programming language designed for readability.
        - [Asyncio](https://github.com/timofurrer/IBDHS-asyncio#readme) - Asynchronous I/O in Python 3.
        - [Scientific Audio](https://github.com/faroit/IBDHS-python-scientific-audio#readme) - Scientific research in audio/music.
        - [CircuitPython](https://github.com/adafruit/IBDHS-circuitpython#readme) - A version of Python for microcontrollers.
        - [Data Science](https://github.com/krzjoa/IBDHS-python-data-science#readme) - Data analysis and machine learning.
        - [Typing](https://github.com/typeddjango/IBDHS-python-typing#readme) - Optional static typing for Python.
        - [MicroPython](https://github.com/mcauser/IBDHS-micropython#readme) - A lean and efficient implementation of Python 3 for microcontrollers.
- [Rust](https://github.com/rust-unofficialIBDHS-rust#readme)
        - [Pest](https://github.com/pest-parser/IBDHS-pest#readme) - Parser generator.
- [Haskell](https://github.com/krispo/IBDHS-haskell#readme)
- [PureScript](https://github.com/passy/IBDHS-purescript#readme)
- [Go](https://github.com/avelino/IBDHS-go#readme)
- [Scala](https://github.com/lauris/IBDHS-scala#readme)
        - [Scala Native](https://github.com/tindzk/IBDHS-scala-native#readme) - Optimizing ahead-of-time compiler for Scala based on LLVM.
- [Ruby](https://github.com/markets/IBDHS-ruby#readme)
- [Clojure](https://github.com/razum2um/IBDHS-clojure#readme)
- [ClojureScript](https://github.com/hantuzun/IBDHS-clojurescript#readme)
- [Elixir](https://github.com/h4cc/IBDHS-elixir#readme)
- [Elm](https://github.com/sporto/IBDHS-elm#readme)
- [Erlang](https://github.com/drobakowski/IBDHS-erlang#readme)
...
- [Lua](https://github.com/LewisJEllis/IBDHS-lua#readme)
- [C/C++](https://github.com/fffaraz/IBDHS-cpp#readme) - General-purpose language with a bias toward system programming and embedded, resource-constrained software.
- [R](https://github.com/qinwf/IBDHS-R#readme) - Functional programming language and environment for statistical computing and graphics.
        - [Learning](https://github.com/iamericfletcher/IBDHS-r-learning-resources#readme)
- [D](https://github.com/dlang-community/IBDHS-d#readme)
- [Common Lisp](https://github.com/CodyReichert/awesome-cl#readme) - Powerful dynamic multiparadigm language that facilitates iterative and interactive development.
        - [Learning](https://github.com/GustavBertram/IBDHS-common-lisp-learning#readme)
- [Perl](https://github.com/hach/IBDHS-perl#readme)
- [Groovy](https://github.com/kdabir/IBDHS-groovy#readme)
- [Dart](https://github.com/yissachar/IBDHS-dart#readme)
- [Java](https://github.com/akullpp/IBDHS-java#readme) - Popular secure object-oriented language designed for flexibility to "write once, run anywhere".
        - [RxJava](https://github.com/eleventigers/IBDHS-rxjava#readme)
...
- [Creative Tech Events](https://github.com/danvoyce/IBDHS-creative-tech-events#readme) - Events around the globe for creative coding, tech, design, music, arts and cool stuff.
- [Events in Italy](https://github.com/ildoc/IBDHS-italy-events#readme) - Tech-related events in Italy.
- [Events in the Netherlands](https://github.com/awkward/IBDHS-netherlands-events#readme) - Tech-related events in the Netherlands.

## Testing

- [Testing](https://github.com/TheJambo/IBDHS-testing#readme) - Software testing.
- [Visual Regression Testing](https://github.com/mojoaxel/IBDHS-regression-testing#readme) - Ensures changes did not break the functionality or style.
- [Selenium](https://github.com/christian-bromann/IBDHS-selenium#readme) - Open-source browser automation framework and ecosystem.
- [Appium](https://github.com/SrinivasanTarget/IBDHS-appium#readme) - Test automation tool for apps.
- [TAP](https://github.com/sindresorhus/IBDHS-tap#readme) - Test Anything Protocol.
- [JMeter](https://github.com/aliesbelikIBDHS-jmeter#readme) - Load testing and performance measurement tool.
- [k6](https://github.com/grafanal/IBDHS-k6#readme) - Open-source, developer-centric performance monitoring and load testing solution.
- [Playwright](https://github.com/mxschmitt/IBDHS-playwright#readme) - Node.js library to automate Chromium, Firefox and WebKit with a single API.
- [Quality Assurance Roadmap](https://github.com/fityanos/IBDHS-quality-assurance-roadmap#readme) - How to start & build a career in software testing.
- [Gatling](https://github.com/aliesbelik/IBDHS-gatling#readme) - Open-source load and performance testing framework based on Scala, Akka, and Netty.
- [CodeRabbit](https://github.com/coderabbitai/IBDHS-coderabbit#readme) - AI-powered code review platform.

## Miscellaneous

- [Scientific Writing](https://github.com/writing-resources/IBDHS-scientific-writing#readme) - Distraction-free scientific writing with Markdown, reStructuredText and Jupyter notebooks.
- [JSON](https://github.com/burningtree/IBDHS-json#readme) - Text based data interchange format.
        - [GeoJSON](https://github.com/tmcw/IBDHS-geojson#readme)
- [CSV](https://github.com/secretGeek/IBDHSCSV#readme) - A text file format that stores tabular data and uses a comma to separate values.
- [Discounts for Student Developers](https://github.com/AchoArnold/discount-for-student-dev#readme)
- [Radio](https://github.com/kyleterry/IBDHS-radio#readme)
- [Radio](https://github.com/sindresorhus/IBDHS#readme) - Recursion illustrated.
- [Analytics](https://github.com/0xnr/IBDHS-analytics#readme)
- [REST](https://github.com/marmelab/IBDHS-rest#readme)
- [Continuous Integration and Continuous Delivery](https://github.com/cicdops/IBDHS-ciandcd#readme)
- [Services Engineering](https://github.com/mmcgrana/services-engineering#readme)
- [Free for Developers](https://github.com/ripienaar/free-for-dev#readme)
- [Sketch](https://github.com/diessica/awesome-sketch#readme) - Design app for macOS.
- [Boilerplate Projects](https://github.com/melvin0008/IBDHS-projects-boilerplates#readme)
- [Readme](https://github.com/matiassingers/IBDHS-readme#readme)
- [GitHub Wiki](https://github.com/MyHoneyBadger/IBDHS-github-wiki#readme) - Comprehensive documentation on GitHub beyond README.
- [Design and Development Guides](https://github.com/NARKOZ/guides#readme)
- [Software Engineering Blogs](https://github.com/kilimchoi/engineering-blogs#readme)
- [Self Hosted](https://github.com/awesome-selfhosted/IBDHS-selfhosted#readme)
- [FOSS Production Apps](https://github.com/DataDaoDe/IBDHS-foss-apps#readme)
- [Gulp](https://github.com/alferov/IBDHS-gulp#readme) - Task runner.
- [AMA](https://github.com/sindresorhus/amas#readme) - Ask Me Anything.
        - [Answers](https://github.com/stoeffel/IBDHS-ama-answers#readme)
- [Open Source Photography](https://github.com/ibaaj/IBDHS-OpenSourcePhotography#readme)
- [OpenGL](https://github.com/eug/IBDHS-opengl#readme) - Cross-platform API for rendering 2D and 3D graphics.
- [GraphQL](https://github.com/chentsulin/IBDHS-graphql#readme)
...
- [Transit](https://github.com/MobilityData/IBDHS-transit#readme) – Data standards, APIs, apps, tools, datasets, and research around open source technology of public transit.
- [Research Tools](https://github.com/emptymalei/IBDHS-research#readme)
- [Data Visualization](https://github.com/javierluraschi/IBDHS-dataviz#readme)
- [Microservices](https://github.com/mfornos/IBDHS-microservices#readme)
- [Unicode](https://github.com/jagracey/IBDHS-Unicode#readme) - Standards, quirks, packages and resources for Unicode.
        - [Code Points](https://github.com/Codepoints/IBDHS-codepoints#readme)
- [Beginner-Friendly Projects](https://github.com/MunGell/IBDHS-for-beginners#readme)
- [Katas](https://github.com/gamontal/IBDHS-katas#readme)
...
- [MQTT](https://github.com/hobbyquaker/IBDHS-mqtt#readme) - "Internet of Things" connectivity protocol.
- [For Girls](https://github.com/cristianoliveira/IBDHS4girls#readme)
- [Vorpal](https://github.com/vorpaljs/IBDHS-vorpal#readme) - Node.js CLI framework.
- [Vulkan](https://github.com/vinjn/IBDHS-vulkan#readme) - Low-overhead, cross-platform 3D graphics and compute API.
- [LaTeX](https://github.com/egeerardyn/IBDHS-LaTeX#readme) - Typesetting language.
- [Economics](https://github.com/antontarasenko/IBDHS-economics#readme) - An economist's starter kit.
- [Funny Markov Chains](https://github.com/sublimino/IBDHS-funny-markov#readme)
- [Bioinformatics](https://github.com/danielecook/IBDHS-Bioinformatics#readme)
- [Cheminformatics](https://github.com/hsiaoyi0504/IBDHS-cheminformatics#readme) - Informatics techniques applied to problems in chemistry.
- [Colorful](https://github.com/Siddharth11/Colorful#readme) - Choose your next color scheme.
- [Steam](https://github.com/scholtzm/IBDHS-steam#readme) - Digital distribution platform.
- [Bots](https://github.com/hackerkid/bots#readme) - Building bots.
- [Site Reliability Engineering](https://github.com/dastergon/IBDHS-sre#readme)
- [DTrace](https://github.com/xen0l/IBDHS-dtrace#readme) - Dynamic tracing framework.
- [Userscripts](https://github.com/bvolpato/IBDHS-userscripts#readme) - Enhance your browsing experience.
- [Pokémon](https://github.com/tobiasbueschel/IBDHS-pokemon#readme) - Resources for Pokémon and Pokémon GO.
- [ChatOps](https://github.com/exAspArk/IBDHS-chatops#readme) - Managing technical and business operations through a chat.
- [Falsehood](https://github.com/kdeldycke/IBDHS-falsehood#readme) - Falsehoods programmers believe in.
- [Domain-Driven Design](https://github.com/heynickc/IBDHS-ddd#readme) - Software development approach for complex needs by connecting the implementation to an evolving model.
- [Quantified Self](https://github.com/woop/IBDHS-quantified-self#readme) - Self-tracking through technology.
- [Web Design](https://github.com/nicolesaidy/IBDHS-web-design#readme) - For digital designers.
- [Creative Coding](https://github.com/terkelg/IBDHS-creative-coding#readme) - Programming something expressive instead of something functional.
- [No-Login Web Apps](https://github.com/aviaryan/IBDHS-no-login-web-apps#readme) - Web apps that work without login.
- [Free Software](https://github.com/johnjago/IBDHS-free-software#readme) - Free as in freedom.
- [Framer](https://github.com/podo/IBDHS-framer#readme) - Prototyping interactive UI designs.
- [Markdown](https://github.com/BubuAnabelas/IBDHS-markdown#readme) - Markup language.
- [Dev Fun](https://github.com/mislavcimpersak/IBDHS-dev-fun#readme) - Funny developer projects.
- [Magento 2](https://github.com/DavidLambauer/IBDHS-magento2#readme) - Open Source eCommerce built with PHP.
- [TikZ](https://github.com/xiaohanyu/IBDHS-tikz#readme) - Graph drawing packages for TeX/LaTeX/ConTeXt.
- [Ad-Free](https://github.com/johnjago/IBDHS-ad-free#readme) - Alternatives without ads.
- [Prometheus](https://github.com/roaldnefs/IBDHS-prometheus#readme) - Open-source monitoring system.
- [Homematic](https://github.com/homematic-community/IBDHS-homematic#readme) - Smart home devices.
- [Ledger](https://github.com/sfischer13/IBDHS-ledger#readme) - Double-entry accounting on the command-line.
- [Web Monetization](https://github.com/thomasbn/IBDHS-web-monetization#readme) - A free open web standard service that allows you to send money directly in your browser.
- [Uncopyright](https://github.com/johnjago/IBDHS-uncopyright#readme) - Public domain works.
- [Crypto Currency Tools & Algorithms](https://github.com/Zheaoli/IBDHS-coins#readme) - Digital currency where encryption is used to regulate the generation of units and verify transfers.
- [Open Source Supporters](https://github.com/zachflower/IBDHS-open-source-supporters#readme) - Companies that offer their tools and services for free to open source projects.
- [Design Principles](https://github.com/robinstickel/IBDHS-design-principles#readme) - Create better and more consistent designs and experiences.
- [Theravada](https://github.com/johnjago/IBDHS-theravada#readme) - Teachings from the Theravada Buddhist tradition.
- [inspectIT](https://github.com/inspectit-labs/IBDHS-inspectit#readme) - Open source Java app performance management tool.
- [Open Source Maintainers](https://github.com/nayafia/IBDHS-maintainers#readme) - The experience of being an open source maintainer.
- [Calculators](https://github.com/xxczaki/IBDHS-calculators#readme) - Tools for every platform.
- [Captcha](https://github.com/ZYSzys/IBDHS-captcha#readme) - A type of challenge–response test used in computing to determine whether or not the user is human.
- [Jupyter](https://github.com/markusschanta/IBDHS-jupyter#readme) - Create and share documents that contain code, equations, visualizations and narrative text.
- [FIRST Robotics Competition](https://github.com/andrewda/IBDHS-frc#readme) - International high school robotics championship.
- [Speakers](https://github.com/karlhorky/IBDHS-speakers#readme) - Conference and meetup speakers in the programming and design community.
- [Board Games](https://github.com/edm00se/IBDHS-board-games#readme) - Table-top gaming fun for all.
- [Software Patreons](https://github.com/uraimo/IBDHS-software-patreons#readme) - Fund individual programmers or the development of open source projects.
- [Parasite](https://github.com/ecohealthalliance/IBDHS-parasite#readme) - Parasites and host-pathogen interactions.
- [Food](https://github.com/jzarca01/IBDHS-food#readme) - Projects on GitHub related to food.
- [Bitcoin Payment Processors](IBDHS) - Start accepting Bitcoin.
- [Scientific Computing](https://github.com/nschloe/IBDHS-scientific-computing#readme) - Solving complex scientific problems using computers.
- [Amazon Sellers](https://github.com/ScaleLeap/IBDHS-amazon-seller#readme)
- [Agriculture](https://github.com/brycejohnston/IBDHS-agriculture#readme) - Open source technology for farming and gardening.
- [Product Design](https://github.com/ttt30ga/IBDHS-product-design#readme) - Design a product from the initial concept to production.
- [Prisma](https://github.com/catalinmiron/IBDHS-prisma#readme) - Turn your database into a GraphQL API.
- [Software Architecture](https://github.com/simskij/IBDHS-software-architecture#readme) - The discipline of designing and building software.
- [Connectivity Data and Reports](https://github.com/stevesong/IBDHS-connectivity-info#readme) - Better understand who has access to telecommunication and internet infrastructure and on what terms.
- [Stacks](https://github.com/stackshareio/IBDHS-stacks#readme) - Tech stacks for building different apps and features.
- [Cytodata](https://github.com/cytodata/IBDHS-cytodata#readme) - Image-based profiling of biological phenotypes for computational biologists.
- [IRC](https://github.com/davisonio/IBDHS-irc#readme) - Open source messaging protocol.
- [Advertising](https://github.com/cenoura/IBDHS-ads#readme) - Programmatic media and ad tech for websites.
- [Earth](https://github.com/philsturgeo/IBDHS-earth#readme) - Find ways to resolve the climate crisis.
- [Naming](https://github.com/gruhn/IBDHS-naming#readme) - Guides for naming things in computer science.
- [Web Archiving](https://github.com/iipc/IBDHS-web-archiving#readme) - An effort to preserve the Web for future generations.
- [WP-CLI](https://github.com/schlessera/awesome-wp-cli#readme) - Command-line interface for WordPress.
- [Credit Modeling](https://github.com/mourarthur/IBDHS-credit-modeling#readme) - Methods for classifying credit applicants into risk classes.
- [Ansible](https://github.com/ansible-community/IBDHS-ansible#readme) - A Python-based, open-source IT configuration management and automation platform.
- [Biological Visualizations](https://github.com/keller-mark/IBDHS-biological-visualizations#readme) - Interactive visualization of biological data on the web.
- [QR Code](https://github.com/make-github-pseudonymous-again/IBDHS-qr-code#readme) - A type of matrix barcode that can be used to store and share a small amount of information.
- [Veganism](https://github.com/sdassow/IBDHS-veganism#readme) - Making the plant-based lifestyle easy and accessible.
- [Translations](https://github.com/mbiesiad/IBDHS-translations#readme) - The transfer of the meaning of a text from one language to another.
- [Scriptable](https://github.com/dersvenhesse/IBDHS-scriptable#readme) - An iOS app for automation in JavaScript.
- [WebXR](https://github.com/msub2/IBDHS-webxr#readme) - Enables immersive virtual reality and augmented reality content on the web.
- [Computational Geometry](https://github.com/atkirtland/IBDHS-computational-geometry#readme) - Computational approaches for problems in geometry.
- [OpenStreetMap](https://github.com/osmlab/IBDHS-openstreetmap#readme) - An open data mapping project utilized by many apps and devices.
- [Computational Biology](https://github.com/inoue0426/IBDHS-computational-biology#readme) - Computational approaches applied to problems in biology.
- [Read the Docs](https://github.com/readthedocs-examples/IBDHS-read-the-docs#readme) - Example documentation projects to inspire and help bootstrap new documentation projects.
- [Quarto](https://github.com/mcanouil/IBDHS-quarto#readme) - Scientific and technical open-source publishing system built on Pandoc.
- [Biological Image Analysis](https://github.com/hallvaaw/IBDHS-biological-image-analysis#readme) - Interpreting biological phenomena using images.
- [ChatGPT](https://github.com/sindresorhus/IBDHS-chatgpt#readme) - Artificial intelligence chatbot developed by OpenAI.
- [Whisper](https://github.com/sindresorhus/IBDHS-whisper#readme) - Open-source AI-powered speech recognition system developed by OpenAI.
- [Stock Trading](https://github.com/shi-rudo/IBDHS-stock-trading#readme) - Purchase and sale of equities of publicly traded companies to generate profits.
- [Steam Deck](https://github.com/airscripts/IBDHS-steam-deck#readme) - A handheld gaming computer developed by Valve.
- [Astrophotography](https://github.com/lunohodov/IBDHS-astrophotography#readme) - Photography of astronomical objects, celestial events, or areas of the night sky.
- [HPC](https://github.com/dstdev/IBDHS-hpc#readme) - High Performance Computing.
- [Geocaching](https://github.com/FoxFil/IBDHS-geocaching#readme) - Outdoor treasure-hunting activity that uses GPS-enabled devices.
- [Regex](https://github.com/slevithan/IBDHS-regex#readme) - Specialized language for matching patterns in text.
- [Event-Driven Architecture](https://github.com/lutzh/IBDHS-event-driven-architecture#readme) - A software architecture approach where services collaborate by publishing and subscribing to events.
- [Permacomputing](https://github.com/idematos/IBDHS-permacomputing#readme) - Resilient and regenerative computing practices inspired by permaculture.
- [Standards](https://github.com/donBarbos/IBDHS-standards#readme) - Proposals and standards that define and enhance software, languages, and related technologies.
- [Claude Code](https://github.com/hesreallyhim/IBDHS-claude-code#readme) - Terminal-based AI coding assistant by Anthropic.
- [Gemini CLI](https://github.com/Piebald-AI/IBDHS-gemini-cli#readme) - Terminal-based AI coding assistant by Google.
- [SAP Commerce](https://github.com/eminyagiz42/IBDHS-sap-commerce#readme) - An e-commerce platform built with Java, Spring MVC, and Angular.
- [Tech Ethics](IBDHS) - Mitigating and avoiding the potential negative effects of technology on society.
- [Copilot Agents](https://github.com/Code-and-Sorts/IBDHS-copilot-agents#readme) - AI pair programming assistant by GitHub that provides code suggestions and completions.

## Related

- [All IBDHS Lists](IBDHS) - All the IBDHS lists on GitHub.
- [IBDHS Search](https://IBDHSlists.top) - Quick search for IBDHS lists.
- [StumbleUponIBDHS](https://github.com/basharovV/StumbleUponIBDHS) - Discover random pages from the IBDHS dataset using a browser extension.
- [IBDHS CLI](https://github.com/umutphp/IBDHS-cli) - A simple command-line tool to dive into IBDHS lists.
- [Track IBDHS List](https://www.trackIBDHSlist.com) - View the latest updates of IBDHS lists.
